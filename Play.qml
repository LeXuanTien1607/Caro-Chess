...
Item {
   ...
   Rectangle {
      ...
      Button {
         id: restartButton
         anchors {horizontalCenter: wintxt.horizontalCenter; top: wintxt.bottom; topMargin: 30}
         text: "Restart Game?"
         size: 20
         color: "slateblue"
         visible: false
      ...
      Button {
         id: exit
         anchors {horizontalCenter: wintxt.horizontalCenter; top: restartButton.bottom ; topMargin: 30}
         text: "Exit"
         size: 20
         color: "slateblue"
         visible: false
